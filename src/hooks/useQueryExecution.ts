...
const generateMockResults = (query: string): ResultsData => {
  ...
  let result: ResultsData = {
    ...
    data: generateRandomCategoryData([
      "Category A",
      "Category B",
      "Category C",
      "Category D",
  ...
  if (lowercaseQuery.includes("revenue") || lowercaseQuery.includes("sales")) {
    result = {
      ...
      description:
        "Monthly revenue over the last year shows seasonal variations with peak performance in Q4.",
      insights: [
    ...
    lowercaseQuery.includes("selling")
  ) {
    result = {
      type: "bar",
      ...
      description:
        "Electronics continues to be our best-performing product category.",
      insights: [
    ...
    lowercaseQuery.includes("region") ||
    ...
    result = {
      ...
      description:
        "North America and Asia are our strongest markets with Europe showing growth potential.",
      insights: [
    ...
    lowercaseQuery.includes("retention") ||
    lowercaseQuery.includes("customer")
  ) {
    result = {
      type: "pie",
      title: "Customer Retention Analysis",
      data: generateRandomPieData([
        "Loyal (>3y)",
        "Regular (1-3y)",
        "New (<1y)",
        "At Risk",
      ...
      description:
        "Our customer base is healthy with strong retention of loyal customers.",
      insights: [
    ...
    result = {
      ...
      description:
        "Email campaigns continue to provide the highest ROI among marketing channels.",
      insights: [
    ...
    (query: string) => {
      ...
      setTimeout(() => {
        try {
          ...
          dispatch(addToHistory({ query, result: results }));
        } catch (err) {
